...
- [Indoor Carbon Dioxide (CO<sub>2</sub>) Levels](sensors#indoor-carbon-dioxide)
  ...
  - **Figure:** [Elsys ERS CO<sub>2</sub> LoRaWAN Sensor*](sensors#image16)
- [Boiler and Domestic Hot Water Temperature](sensors#boiler-domestic-hot)
  ...
  - **Figure:** [A Temperature Probe Correctly Installed on a Pipe (heat sink compound promotes good thermal contact and accurate temperature readings)](sensors#image19)
...
- [Building Fuel Use Data](sensors#building-fuel-use)
  ...
  - **Figure:** [Natural Gas Meter With a Monnit Wireless Pulse Counter (also shown is a flexible conduit leading to a wireless pulse counter that records and trsnmits the reading to BMON)](sensors#image22)
  - **Figure:** [Typical LoRaWAN Pulse Counter, [Elsys ELT-Lite LoRaWAN Sensor](https://www.elsys.se/en/lora-elt-lite/)](sensors#image9)
  - **Figure:** [An Elster 4p Fuel Flow Meter Installation (the flow meter is the translucent enclosure in the upper right hand corner of the picture)](sensors#image23)
