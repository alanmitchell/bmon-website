...
# **Appendix A: Configuring LoRaWAN Sensors for BMON**
{: #appendix-configuring-lorawan}

This Appendix shows how to:

  - Register a LoRaWAN sensor on the Things Network, the freely
    available network of servers that can accept sensor readings and
    forward them to BMON. This Appendix assumes that there already is a
    Things Network account set up, and that there is an Application set
    up in that account that has the proper Integration for forwarding
    sensor readings to BMON.

  - Configure Elsys and Dragino sensors for use with your Things Network
    account and BMON.

## **Registering a Sensor on the Things Network**
{: #registering-sensor-things}
...
inside of BMON, not in the Things Application. on Adding a Device.
...
with a code indicating the model of sensor. For the sensors know by
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image4.png)
<br>{: #image4}*Caption*
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image5.png)
<br>{: #image5}*Caption*
...
phone to WiFi and download the necessary app.
...
[Video Configuring Elsys Sensors with your
*Caption*
{% include video id="654345666" provider="vimeo" %}
Smartphone](https://vimeo.com/654345666)
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image6.jpeg)
<br>{: #image6}*Caption*
...
The sensor used in the this example is an ELT Lite sensor, which has
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image7.jpeg)
<br>{: #image7}*Caption*
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image8.jpeg)
<br>{: #image8}*Caption*
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image9.jpeg)
<br>{: #image9}*Caption*
...
![]({{ site.baseurl }}/assets/guide/appx-config-lorawan/image10.png)
<br>{: #image10}*Caption*
...
[**Table 1**](https://docs.google.com/document/d/10yhTZH4IRDuP7ZAPamcgTdtllEGLCltQcuFigTlh6A4/edit#table_sensor):
Elsys External Sensor Wiring and Configuration
...
<img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image11.png" style="width:0.95069in;height:1.46319in" /></p></td>
...
<img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image12.png" style="width:1.78125in;height:1.18056in" /></td>
...
<p>The other critical setting in the “Sample times" section of the configuration is the “External startup time", which should be set to 10 million (10000000, a 1 with seven zeroes and no commas). This setting ensures that battery power will be continuously delivered to the Motor Sensor from the Elysys ELT.</p></td>
...
<p><img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image13.png" style="width:2.6875in;height:2.86111in" /></p>
...
<p><img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image14.png" style="width:1.59861in;height:1.29514in" /></p>
...
<p><img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image15.png" style="width:2.05764in;height:1.85in" /></p>
...
[**Table 2**](https://docs.google.com/document/d/10yhTZH4IRDuP7ZAPamcgTdtllEGLCltQcuFigTlh6A4/edit#table_misc_sensors):
Use and Configuration of Selected LoRaWAN Sensors
...
<p><img src="{{ site.baseurl }}/assets/guide/appx-config-lorawan/image16.png" style="width:2.6875in;height:2.69444in" /></p></td>
<td><p>The temperatures sensor show up as “xxx_extTemperature1", “xxx_extTemperature2", and “xxx_extTemperature3" (°F units) Sensor ID, where “xxx" is the Device ID (EUI). The color coding on the probes is as follows:</p>
